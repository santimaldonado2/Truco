...
public class Estado implements TreeNode {
    ...
    public Estado clone(){
        Estado e = new Estado(this.ronda.clone(),this.baraja.clone(),(LinkedList<Estado>)this.children.clone(),(LinkedList<Carta>) this.cartasMano.clone());
        return e;
    }
...
//            this.addChildren(new Estado(rondaAux,this.baraja.clone(),cartasNoJugadas));
//        }
//    }
...
//                this.addChildren(new Estado(rondaAux,barajaRestante,(LinkedList<Carta>) this.cartasMano.clone()));
//            }
//        }
//    }
//
